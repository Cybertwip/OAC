...
namespace anim
{
    ...
    void SequenceAnimator::update(float dt)
    {
        if (!is_stop_)
        {
    ...
    void SequenceAnimator::update_animation(AnimationComponent *animation, Entity *root, Shader *shader)
    {
    ...
    void SequenceAnimator::calculate_bone_transform(Entity *entity, Animation *animation, const glm::mat4 &parentTransform)
    {
    ...
    const float SequenceAnimator::get_current_time() const
    {
        return current_time_;
    }
    const float SequenceAnimator::get_start_time() const
    {
        return start_time_;
    }
    const float SequenceAnimator::get_end_time() const
    {
        return end_time_;
    }
    const float SequenceAnimator::get_fps() const
    {
        return fps_;
    }
    const float SequenceAnimator::get_direction() const
    {
        return direction_;
    }
    const bool SequenceAnimator::get_is_stop() const
    {
        return is_stop_;
    }
    void SequenceAnimator::set_current_time(float current_time)
    {
        current_time_ = current_time;
    }
    void SequenceAnimator::set_start_time(float time)
    {
        start_time_ = time;
    }
    void SequenceAnimator::set_end_time(float time)
    {
        end_time_ = time;
    }
    void SequenceAnimator::set_fps(float fps)
    {
        fps_ = fps;
    }
    void SequenceAnimator::set_direction(bool is_left)
    {
        direction_ = 1.0f;
        if (is_left)
        {
    ...
    void SequenceAnimator::set_is_stop(bool is_stop)
    {
        is_stop_ = is_stop;
    }
